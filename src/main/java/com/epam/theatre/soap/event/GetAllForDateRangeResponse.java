...
@XmlRootElement(name = "getAllForDateRangeResponse", namespace = "http://impl.service.theatre.epam.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getAllForDateRangeResponse", namespace = "http://impl.service.theatre.epam.com/")
