...
@XmlRootElement(name = "getAllByNameResponse", namespace = "http://impl.service.theatre.epam.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getAllByNameResponse", namespace = "http://impl.service.theatre.epam.com/")
